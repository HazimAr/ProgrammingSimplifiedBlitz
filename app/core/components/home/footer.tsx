import { Divider, Heading, HStack, Text, useToken, VStack } from "@chakra-ui/react"
...
export default function Footer() {
  ...
  return (
    <Container color="#808080" bg="#101010" py="100px" mt="200px" textAlign="center">
      <ContainerInside>
        <VStack
          bg="gradient"
          rounded={rounded}
        ...
        >
          <VStack maxW="500px" px="25px" color="white">
            ...
            <Text fontSize={{ base: "sm", sm: "lg" }} color="#ccc">
              Build up your programming knowledge and take as long as you need.
            </Text>
            <HStack>
        ...
        >
          <HStack>
            <NextChakraLink href="/instagram" fontSize="0px" isExternal>
              Instagram
              <FaInstagram size="25px" />
            </NextChakraLink>
            <NextChakraLink href="/discord" fontSize="0px" isExternal>
              Discord
              <FaDiscord size="25px" />
            </NextChakraLink>
          </HStack>
          <Text size="md">
            ©️ 2021 Copyright. <span style={{ color: primary }}>Programming Simplified</span>
          </Text>
        </HStack>
      </ContainerInside>
    </Container>
