import { Box, Heading, HStack, Image, Stack, Text, useToken } from "@chakra-ui/react"
...
export default function Hero() {
  ...
  return (
    <Container pt="25px" pb="100px">
      <ContainerInside>
        <HStack mt={{ base: "90px", md: 0 }} flexDir={{ base: "column", md: "row" }} spacing="0">
          <motion.div
          ...
          >
            ...
            >
              ...
              <Heading as="h1" fontWeight="normal" size="2xl">
                <span>Improve</span> your <span>skills</span> by learning from{" "}
              ...
              <Text w="40ch">
                Create, launch, and produce projects by gaining coding skills through an innovative
                way of learning.
              </Text>
