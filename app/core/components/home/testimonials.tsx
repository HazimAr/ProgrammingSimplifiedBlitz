import { Heading, HStack, SimpleGrid, Stack, Text, useToken } from "@chakra-ui/react"
...
export default function Testimonials() {
  ...
  return (
    <Container bg="white" py="100px">
      <ContainerInside>
        <HStack flexDir={{ base: "column", lg: "row" }} spacing={{ base: 0, lg: "50px" }}>
          <motion.div
          ...
          >
            ...
            >
              ...
              <Text>
                We are a team of developers, designers, and creators here to help you learn, grow,
                and succeed. Here are some testimonials from our students
              </Text>
            </Stack>
          </motion.div>
          <SimpleGrid
          ...
          >
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                viewport={{ amount: 0.1 }}
              >
                <Card isBlue={index % 2 == 1} {...testimonial} />
              </motion.div>
            ))}
          </SimpleGrid>
        </HStack>
...
const testimonials = [
  ...
  {
    name: "Daniyal S.",
    testimonial: "I'm so glad I found Programming Simplified.  It's a great place to learn.",
    title: "Student",
  },
  {
    name: "Kaylee A.",
    testimonial: "I've learned so much from this course! I'm so excited to continue learning!",
    title: "Student",
  },
]
