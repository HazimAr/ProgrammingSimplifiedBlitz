...
import { getUserCourses } from "app/core/api/index"
...
function Stat({ course }) {
  return (
    <Card href={`/dashboard/courses/${course.id}/lessons/${course.currentLesson}`}>
      <CircularProgress value={course.progress * 100} color="primary" size="120px">
        <CircularProgressLabel>
